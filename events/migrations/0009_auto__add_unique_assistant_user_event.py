...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Assistant', fields ['user', 'event']
        db.create_unique(u'events_assistant', ['user_id', 'event_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Assistant', fields ['user', 'event']
        db.delete_unique(u'events_assistant', ['user_id', 'event_id'])


    models = {
        u'events.assistant': {
            'Meta': {'unique_together': "(('user', 'event'),)", 'object_name': 'Assistant'},
