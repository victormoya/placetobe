...
(function($) {
    ...
    // bootstrap3_datetime, timepicker init
    grappelli.initDateAndTimePicker = function() {
        ...
        var options = {
            ...
            // see onClick handler for ".ui-bootstrap3_datetime-current"
        ...
        // HACK: adds an event listener to the today button of bootstrap3_datetime
        // if clicked today gets selected and bootstrap3_datetime hides.
        // use on() because couldn't find hook after bootstrap3_datetime generates it's complete dom.
